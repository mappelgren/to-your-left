...
The basis for my datasets is the Visual Question Answering (VQA) dataset CLEVR \citep{Johnson2016}.
...
Traditional approaches involve extracting key points and descriptors from an image and using them to represent the image (\cite{Harris1988}, \cite{Lowe1999}, \cite{Bay2006}).
