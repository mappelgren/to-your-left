...
\begin{figure}[ht!]
    \centering
    \subfigure[\emph{Dale-2} dataset]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_coordinate-predictor_dale-2.png}
        \label{fig:learning-curve_coordinate-predictor_dale-2}
    }
    \subfigure[\emph{Dale-5} dataset]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_coordinate-predictor_dale-5.png}
        \label{fig:learning-curve_coordinate-predictor_dale-5}
    }
    \subfigure[\emph{CELVR color} dataset]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_coordinate-predictor_colour.png}
        \label{fig:learning-curve_coordinate-predictor_colour}
    }
    \caption{Learning curves of all discrimination games on each dataset. As almost no games beat the baseline, $|V|$ and $n$ are not highlighted separately. The baseline is marked in black.}
...
Looking at the results on the \emph{Dale-5}, no improvements for the mean distance nor the accuracy can be seen when a sender is involved.
...
\begin{figure}[ht!]
    ...
    \subfigure[\emph{Dale-2} dataset with different $|V|$ highlighted]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_attention-predictor_dale-2_vocab-size.png}
        \label{fig:learning-curve_attention-predictor_dale-2_vocab-size}
    }
    \subfigure[\emph{Dale-2} dataset with different $n$ highlighted]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_attention-predictor_dale-2_max-len.png}
        \label{fig:learning-curve_attention-predictor_dale-2_max-len}
    }
    \subfigure[\emph{Dale-5} dataset with different $|V|$ highlighted]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_attention-predictor_dale-5_vocab-size.png}
        \label{fig:learning-curve_attention-predictor_dale-5_vocab-size}
    }
    \subfigure[\emph{Dale-5} dataset with different $n$ highlighted]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_attention-predictor_dale-5_max-len.png}
        \label{fig:learning-curve_attention-predictor_dale-5_max-len}
    }
    \subfigure[\emph{CLEVR color} dataset with different $|V|$ highlighted]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_attention-predictor_colour_vocab-size.png}
        \label{fig:learning-curve_attention-predictor_colour_vocab-size}
    }
    \subfigure[\emph{CLEVR color} dataset with different $n$ highlighted]{
        \includegraphics[width=0.46\linewidth]{figures/learning-curve_attention-predictor_colour_max-len.png}
        \label{fig:learning-curve_attention-predictor_colour_max-len}
    }
    \caption{Learning curves of all discrimination games on each dataset. In the left column, the colors correspond to different vocabulary sizes $|V|$ while in the right column, the colors correspond to different message lengths $n$. The baseline is marked in black.}
...
On the \emph{Dale-5} dataset, the agents already have bigger problems to beat the baseline.
