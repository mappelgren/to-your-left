...
\cmtDK[inline]{importance of grounding and what it is}

\subsection{Referring expressions}
\cmtDK[inline]{what are referring expressions and how are they studied (generation, understanding, ...)}
\cmtDK[inline]{incremental GRE algorithm from Dale}
