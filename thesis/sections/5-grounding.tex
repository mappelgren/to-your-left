...
In the first setup, the \emph{bounding box RE generator}, the model receives the bounding boxes as input (see Figure \ref{fig:bb_re_generator_architecture}).
...
Therefore, it is extended in a second step with attention to the target object, the \emph{masked RE generator} (see Figure \ref{fig:masked_re_generator_architecture}).
