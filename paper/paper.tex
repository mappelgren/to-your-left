...
One agent is describing the entities represented as features within bounding boxes of objects, inventing new vocabulary as neccessary, and the other agent learns to interpret the reference of symbols by identifying % and referring to
