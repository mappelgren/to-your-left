...
one of the bounding boxes based on object attributes such as shape, color and size.
...
For each image fixed size bounding boxes around the center point of each object are extracted.
...
The results are evaluated using the accuracy if the receiver could identify the target object.
