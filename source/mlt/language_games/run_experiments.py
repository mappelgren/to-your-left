...
variables = {
    ...
    "--receiver_hidden": [100, 500, 1000],
    # "--receiver_projection": [100],
    "--receiver_image_embedding": [500],
    # "--receiver_decoder_out": [1500],
    # "--receiver_decoder_embedding": [15],
    # "--receiver_coordinate_classifier_dimension": [2048],
    "--vocab_size": [2, 10, 16, 50, 100],
    "--max_len": [1, 2, 3, 4, 6],
}
