...
from egg_models import ReferentialGameReceiver, ReferentialGameSender
...
def main(params):
    ...
    receiver = ReferentialGameReceiver(opts.receiver_hidden)
    sender = ReferentialGameSender(opts.sender_hidden)
